"""Snake, with two challenges added: a board that wraps round, and a count of meals.

Both are options or attributes of the existing classes. Nothing else had to change.
"""
