...
ROOMS = {
    ...
    "landing": Room(
        ...
        "into darkness. The stairs go down, and the bathroom is to the east.",
        {Direction.DOWN: "hall", Direction.UP: "attic", Direction.EAST: "bathroom"},
    ),
    "bathroom": Room(
        "The Bathroom",
        "An avocado suite, with a carpeted lavatory seat. The landing is to the west.",
        {Direction.WEST: "landing"},
    ),
    "attic": Room(
        "The Attic",
...
ITEMS = {
    ...
    "duck": Item("duck", "A rubber duck. It has seen things."),
    "flowerpots": Item(
        "flowerpots",
