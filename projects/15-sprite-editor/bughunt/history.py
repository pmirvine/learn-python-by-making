"""A colleague's History, from before yours. Something is wrong with Redo.
...
def main() -> None:
    ...
    history.redo()
    show(sprite, "Redo, which ought to have done nothing:")

    history.undo()
    show(sprite, "Undo, which has made a hole:")
