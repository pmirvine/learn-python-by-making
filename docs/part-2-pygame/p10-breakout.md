...
Two games, and not a sound out of either of them. A BBC Micro had a sound chip with three channels and a noise generator, and two famously cryptic commands to drive it, `SOUND` and `ENVELOPE`. In [Project 11](p11-sound-and-envelope.md) you'll make sounds out of nothing but numbers, and the `beeb` package of Project 8 will learn to sing.
