...
You've now written four or five classes that are *almost* alike, more than once: three kinds of thing in space in Asteroids, two kinds of dataclass here with the same decorations. Project 12 told you to hold that thought. In [Project 15](p15-sprite-editor.md) you'll build a sprite editor, with tools, and undo, and at last there's a family of classes with enough in common to deserve a parent.
