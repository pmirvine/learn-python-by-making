...
PyFax is a site that you read. In Project 21 you'll build one that you *play*: the text adventure from Project 5, in a browser, with a session for every player, and pages that change without reloading, by way of a small library called htmx.
