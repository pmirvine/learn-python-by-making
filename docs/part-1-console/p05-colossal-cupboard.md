...
The ant lived on a set of tuples, in a world without edges. So does the most famous program in the history of recreational computing, and it's next: [Project 6](p06-life.md) is Conway's Game of Life. It brings *generators*, which are Python's way of describing a sequence that never ends, and it's where your work goes up on GitHub.
