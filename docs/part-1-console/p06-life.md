...
One project of Part 1 remains, and it makes pictures: the Mandelbrot set, as PNG files, in colour. [Project 7](p07-fractal-factory.md) is about numbers, which hold more surprises than you'd think, and about what functions can do when you stop thinking of them as subroutines and start treating them as values.
