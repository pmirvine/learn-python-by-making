...
Your programs have fitted in one file so far, more or less. The next one won't. Project 5 is a text adventure: a world of rooms, a player with an inventory, a parser that understands `take rusty key`, and saved games. It needs proper structure, and Python has plenty to offer.
