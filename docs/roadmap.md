...
| :material-check: | [26 · Adventure, Third Edition — Textual](part-5-tui/p26-adventure-third-edition.md) | One engine, three front ends: what makes code portable, `Protocol` or ABC, adapters, which way dependencies point, undo as a list of values | A test that reads your imports, with `ast` |
